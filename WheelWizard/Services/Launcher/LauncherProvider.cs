...
/// <summary>
/// Resolves the launcher the Home page should drive. The recomp is an opt-in beta that, when
/// enabled, replaces the Dolphin/Retro Rewind frontend entirely; which launcher that decision
